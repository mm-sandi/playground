...
| C1-E2E-033 | 1 | Ranking (RNK) | Exclusive | Choice Selection | Narrowed to 1 Exclusive choice → no auto-rank. | Editor: Ranking required=All; narrowed choice = Exclusive. | Publish. 2. Trigger. | Displayed. | NT |
...
| E2E-GAP-006 | RNK | RNK exclusive choice — assigned at rank N clears all other ranks; subsequent rank slots filled with exclusive choiceId in saved data | Create survey: Q1 (Ranking, 5 choices, choice-5=Exclusive, required=All). Publish. | Open Answer. Rank choice-1→rank1, choice-2→rank2. Then assign choice-5→rank3. Observe ranks 1–5. Click Next. | Exclusive choice-5 selected at rank3; choices 1 and 2 cleared; in saved data: rank1 and rank2 entries removed; rank3=choice-5 recorded; ranks 4 and 5 filled with choice-5 Id per spec (exclusive propagates to subsequent rank slots up to Modified Response Count). Required=All satisfied. | NT |
